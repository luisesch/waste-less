...
.mj-column-px-400 { width:400px !important; max-width: 400px; }
    ...
    <!-- Image Header -->
      ...
      >
        ...
        <v:fill  origin="0.5, 0" position="0.5, 0" src="https://i1.wp.com/foodandnutrition.org/wp-content/uploads/2017/04/reduce_waste_bulk_bins.jpg?resize=678%2C381&ssl=1" type="tile" />
        <v:textbox style="mso-fit-shape-to-text:true" inset="0,0,0,0">
      <![endif]-->
          
      <div  style="background:url(https://i1.wp.com/foodandnutrition.org/wp-content/uploads/2017/04/reduce_waste_bulk_bins.jpg?resize=678%2C381&ssl=1) top center / cover no-repeat;Margin:0px auto;max-width:600px;">
        <div  style="line-height:0;font-size:0;">
        <table
           align="center" background="https://i1.wp.com/foodandnutrition.org/wp-content/uploads/2017/04/reduce_waste_bulk_bins.jpg?resize=678%2C381&ssl=1" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:url(https://i1.wp.com/foodandnutrition.org/wp-content/uploads/2017/04/reduce_waste_bulk_bins.jpg?resize=678%2C381&ssl=1) top center / cover no-repeat;width:100%;"
        >
          <tbody>
            <tr>
              <td
      ...
      <div
         style="font-family:Helvetica Neue;font-size:35px;line-height:1;text-align:center;color:#fff;"
      >
        <br/></br/>Let the games begin
      </div>
    ...
    <!-- Intro text -->
      ...
      >
        You've been invited to join a new league.<br/><br/> Accept your invitation by clicking on the link below.
      </div>
      ...
      >
        <tr>
          ...
          >
            <a
               href="${message}" style="background:#F45E43;color:#ffffff;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;font-weight:normal;line-height:120%;Margin:0;text-decoration:none;text-transform:none;" target="_blank"
            >
      ...
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:left;color:#525252;"
      >
        Have a great league!<br/><br/> Janine and Luise
      </div>
