...
.mj-column-px-400 { width:400px !important; max-width: 400px; }
    ...
    <!-- Intro text -->
      ...
      >
        Thank you for joining waste-less!<br/><br/> Before you start competing with your friends and family, please take a moment to verify your email address by clicking on the button below.
      </div>
      ...
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:left;color:#525252;"
      >
        Thanks a lot!<br/><br/> Janine and Luise
      </div>
