...
.mj-column-px-400 { width:400px !important; max-width: 400px; }
    ...
    <!-- Image Header -->
      ...
      >
        ...
        <v:fill  origin="0.5, 0" position="0.5, 0" src="https://media.graytvinc.com/images/810*455/Fireworks_MGN.jpg" type="tile" />
        <v:textbox style="mso-fit-shape-to-text:true" inset="0,0,0,0">
      <![endif]-->
          
      <div  style="background:url(https://media.graytvinc.com/images/810*455/Fireworks_MGN.jpg) top center / cover no-repeat;Margin:0px auto;max-width:600px;">
        <div  style="line-height:0;font-size:0;">
        <table
           align="center" background="https://media.graytvinc.com/images/810*455/Fireworks_MGN.jpg" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:url(https://media.graytvinc.com/images/810*455/Fireworks_MGN.jpg) top center / cover no-repeat;width:100%;"
        >
          <tbody>
            <tr>
              <td
    ...
    <!-- Intro text -->
      ...
      >
        You've been invited to join waste-less
      </div>
      ...
      >
        Your friend would like you to join waste-less.<br/><br/> Waste-less is a platform for competing with your friends in who is producing less waste.
      </div>
      ...
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:left;color:#525252;"
      >
        Looking forward to seeing you!<br/><br/> Janine and Luise
      </div>
