...
.mj-column-px-400 { width:400px !important; max-width: 400px; }
    ...
    <!-- Image Header -->
      ...
      >
        ...
        <v:fill  origin="0.5, 0" position="0.5, 0" src="http://www.myecoego.pl/wp-content/uploads/2018/04/zero-waste-1.jpg" type="tile" />
        <v:textbox style="mso-fit-shape-to-text:true" inset="0,0,0,0">
      <![endif]-->
          
      <div  style="background:url(http://www.myecoego.pl/wp-content/uploads/2018/04/zero-waste-1.jpg) top center / cover no-repeat;Margin:0px auto;max-width:600px;">
        <div  style="line-height:0;font-size:0;">
        <table
           align="center" background="http://www.myecoego.pl/wp-content/uploads/2018/04/zero-waste-1.jpg" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:url(http://www.myecoego.pl/wp-content/uploads/2018/04/zero-waste-1.jpg) top center / cover no-repeat;width:100%;"
        >
          <tbody>
            <tr>
              <td
    ...
    <!-- Intro text -->
      ...
      >
        Your league has just started.<br/><br/> Collect your first points and make it to the top of the ranking.
      </div>
      ...
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:left;color:#525252;"
      >
        Good luck!<br/><br/> Janine and Luise
      </div>
